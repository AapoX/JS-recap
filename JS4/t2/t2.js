...
function displayRestaurants() {
  ...
  sortedRestaurants.forEach((restaurant) => {
    ...
    row.dataset.restaurantId = restaurant._id;
...
function highlightRestaurant(selectedRow) {
  const allRows = document.querySelectorAll('.restaurant-row');
